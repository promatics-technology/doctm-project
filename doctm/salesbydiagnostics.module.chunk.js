webpackJsonp(["salesbydiagnostics.module"],{

/***/ "../../../../../src/app/header-six-layout/salesbydiagnostics/number-to-words.ts":
...
/***/ "../../../../../src/app/header-six-layout/salesbydiagnostics/salesbydiagnostics-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SalesbydiagnosticsRoutingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__salesbydiagnostics_component__ = __webpack_require__("../../../../../src/app/header-six-layout/salesbydiagnostics/salesbydiagnostics.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__salesbydiagnostics_component__["a" /* SalesbydiagnosticsComponent */]
    }
];
var SalesbydiagnosticsRoutingModule = /** @class */ (function () {
    function SalesbydiagnosticsRoutingModule() {
    }
    SalesbydiagnosticsRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* RouterModule */].forChild(routes)],
            exports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* RouterModule */]]
        })
    ], SalesbydiagnosticsRoutingModule);
    return SalesbydiagnosticsRoutingModule;
}());
...
/***/ "../../../../../src/app/header-six-layout/salesbydiagnostics/salesbydiagnostics.component.css":
...
var SalesbydiagnosticsComponent = /** @class */ (function () {
    function SalesbydiagnosticsComponent(formBuilder, toastr, userService, router, dialog) {
    ...
    SalesbydiagnosticsComponent.prototype.ngOnInit = function () {
        this.dataDoctors = [];
    ...
    SalesbydiagnosticsComponent.prototype.checkIfAddress = function () {
    ...
    SalesbydiagnosticsComponent.prototype.ngOnDestroy = function () {
        // localStorage['patientDataForDiagnostics'] = null
        localStorage.removeItem('patientDataForDiagnostics');
    };
    SalesbydiagnosticsComponent.prototype.addRow = function () {
        this.totalTr.push(1);
    ...
    SalesbydiagnosticsComponent.prototype.removeRow = function (i) {
    ...
    SalesbydiagnosticsComponent.prototype.getTotalRecord = function (i) {
        this.totalPRate = 0;
    ...
    SalesbydiagnosticsComponent.prototype.onTextChangeOfMedName = function (type, observation) {
        var _this = this;
        if (type != "") {
            var object = {
                category: type,
    ...
    //   }
    // }
    SalesbydiagnosticsComponent.prototype.calculateReturn = function () {
        this.partyTotal = this.totalNetAmount - this.returnEditable;
    };
    SalesbydiagnosticsComponent.prototype.findMedicinesFromStock = function () {
        var _this = this;
        this.loading = true;
        // let object = {
        ...
        // }
        this.userService.FindTestForDiagnostics(this.diagnosticsData.dataSmartDiagnostics._id).subscribe(function (data) {
            console.log(data);
            for (var i = 0; i < _this.reqData.opt.length; i++) {
                for (var j = 0; j < data.data.length; j++) {
                    if (data.data[j].category == _this.reqData.opt[i] && data.data[j].name == _this.reqData.product[i]) {
                        _this.reqData.mrp[i] = data.data[j].rate;
                        _this.reqData.discount[i] = data.data[j].discount;
                        _this.reqData.amount[i] = data.data[j].rate - ((data.data[j].discount / 100) * data.data[j].rate);
                        _this.getTotalRecord(i);
                        break;
                    }
                }
            }
    ...
    SalesbydiagnosticsComponent.prototype.findSingleMedicinesFromStock = function (index, type, medication) {
    ...
    SalesbydiagnosticsComponent.prototype.resetReturn = function () {
        this.returnQty = [];
        this.returnStatus = [];
        this.returnPurchaseArray = [];
    ...
    SalesbydiagnosticsComponent.prototype.onKey = function (event, type) {
        if (event.keyCode == 13) {
            if (type == 'bill') {
                //this.fetchBill()
            }
    ...
    SalesbydiagnosticsComponent.prototype.saveSalesDetails = function () {
        var _this = this;
        this.returnEditable = 0;
        this.quantityReturn = 0;
        ...
        this.loading = true;
        this.userService.SaveDiagnosticsSaleWithPrescription(ob).subscribe(function (data) {
            console.log(data);
            _this.loading = false;
            if (data.response == true) {
    ...
    //     });
    // }
    SalesbydiagnosticsComponent.prototype.getReturnStatus = function (i) {
        if (this.returnStatus[i] == true) {
            return false;
        }
        else {
    ...
    SalesbydiagnosticsComponent.prototype.getTotalReturn = function () {
        for (var i = 0; i < this.returnPurchaseArray.quantity.length; i++) {
    ...
    SalesbydiagnosticsComponent.prototype.updateReturnAmount = function () {
        for (var i = 0; i < this.returnPurchaseArray.quantity.length; i++) {
            if (this.returnPurchaseArray.quantity[i] < this.returnQty[i]) {
                this.toastr.warning("Return quantity can't exceed actual quantity", "Warning");
                return;
    ...
    SalesbydiagnosticsComponent.prototype.openConfirmation = function (activity) {
        var _this = this;
    ...
    SalesbydiagnosticsComponent.prototype.getDoctorName = function (id) {
    ...
    SalesbydiagnosticsComponent.prototype.getData = function (data) {
        if (data % 1 != 0) {
    ...
    SalesbydiagnosticsComponent.prototype.getDoctorNameoforData = function (doc) {
    ...
    SalesbydiagnosticsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-salesbydiagnostics',
            template: __webpack_require__("../../../../../src/app/header-six-layout/salesbydiagnostics/salesbydiagnostics.component.html"),
            styles: [__webpack_require__("../../../../../src/app/header-six-layout/salesbydiagnostics/salesbydiagnostics.component.css")],
    ...
    ], SalesbydiagnosticsComponent);
    return SalesbydiagnosticsComponent;
}());
...
/***/ "../../../../../src/app/header-six-layout/salesbydiagnostics/salesbydiagnostics.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SalesbydiagnosticsModule", function() { return SalesbydiagnosticsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__salesbydiagnostics_routing_module__ = __webpack_require__("../../../../../src/app/header-six-layout/salesbydiagnostics/salesbydiagnostics-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__salesbydiagnostics_component__ = __webpack_require__("../../../../../src/app/header-six-layout/salesbydiagnostics/salesbydiagnostics.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__number_to_words__ = __webpack_require__("../../../../../src/app/header-six-layout/salesbydiagnostics/number-to-words.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SalesbydiagnosticsModule = /** @class */ (function () {
    function SalesbydiagnosticsModule() {
    }
    SalesbydiagnosticsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"],
                __WEBPACK_IMPORTED_MODULE_2__salesbydiagnostics_routing_module__["a" /* SalesbydiagnosticsRoutingModule */],
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_3__salesbydiagnostics_component__["a" /* SalesbydiagnosticsComponent */], __WEBPACK_IMPORTED_MODULE_9__number_to_words__["a" /* NumberToWords */]]
        })
    ], SalesbydiagnosticsModule);
    return SalesbydiagnosticsModule;
}());
...
//# sourceMappingURL=salesbydiagnostics.module.chunk.js.map