...
@Component({
  ...
  templateUrl: './dashboard-diagnostics-detail.component.html',
  styleUrls: ['./dashboard-diagnostics-detail.component.css']
})
export class DashboardDiagnosticsDetailComponent implements OnInit {
