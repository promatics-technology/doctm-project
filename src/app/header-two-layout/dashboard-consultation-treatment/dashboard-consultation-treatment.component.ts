...
@Component({
    ...
    templateUrl: './dashboard-consultation-treatment.component.html',
    styleUrls: ['./dashboard-consultation-treatment.component.css']
})
export class DashboardConsultationTreatmentComponent implements OnInit {
    doctorData
    activatedtab
    totalPatient
    totalWalkinPatient
    ...
    activatetab(i) {
        ...
        this.userService.PharmacyAnalytics(object).subscribe((result) => {
            ...
            if (result.response) {
                ...
                console.log(this.totalPharmacySalesLength,this.totalWalkinPatient )
