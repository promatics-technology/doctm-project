...
@Component({
    ...
    templateUrl: './dashboard-savedpreset.component.html',
    styleUrls: ['./dashboard-savedpreset.component.css'],
    providers: [UserService]
})
export class DashboardSavedpresetComponent implements OnInit {

    headingName: string
    condition = 'abc'
    doctorData
    dataArray
    PresetSavedArrayData
    PresetSavedData
    PresetSavedOtherData
    DoctorSavedPrescriptionPadData
    MedicationSuggestionsData
    ...
    GetAllPresetsOfDoctor() {
        this.userService.GetAllPresetsOfDoctor(this.doctorData.itemId).subscribe(data => {
            console.log(data)
            if (data.response == true) {
                this.PresetSavedArrayData = data.PresetSavedArrayData
                this.PresetSavedData = data.PresetSavedData
                this.PresetSavedOtherData = data.PresetSavedOtherData
                this.DoctorSavedPrescriptionPadData = data.DoctorSavedPrescriptionPadData
                this.MedicationSuggestionsData = data.MedicationSuggestionsData
                if (this.condition == 'med_info') {
                    this.selectChangeMedInfo()
                } else {
                    this.selectChange()
                }
            }
    ...
    openDialog(data): void {
        ...
        dialogRef.afterClosed().subscribe(result => {
            ...
            if (result == "yes") {
                ...
                this.userService.DeletePreset(object).subscribe(data => {
                    console.log(data);
                    if (data.response == true) {
        ...
        if (flag == 'findings') {
            ...
            if (this.totalMedications >= 0) {
                ...
                if (boolean == false) {
                    ...
                    console.log(object)
                    this.userService.UpdateDoctorPreset(object).subscribe(data => {
                        console.log(data)
                        if (data.response == true) {
                            this.toastr.success(data.message, "Success")
                            this.ngOnInit()
                            ...
                            if (data.message == "Data already exists") {
                                ...
                                dialogRef.afterClosed().subscribe(result => {
                                    ...
                                    if (result == "yes") {
                                        ...
                                        this.userService.UpdateMedicationSuggestion(object).subscribe(data => {
                                            this.toastr.success(data.message, "Success")
                                            this.medication_type = 'abc'
                                            this.ngOnInit()
                                        }, err => {
            ...
            if (objectArray.length > 0) {
                ...
                this.userService.UpdatePrescriptionPad(dataToSave).subscribe(data => {
                    console.log(data)
                    if (data.response == true) {
                        this.toastr.success(data.message, "Success")
                        this.ngOnInit()
                        ...
                        if (data.message == "Data already exists") {
                            ...
                            dialogRef.afterClosed().subscribe(result => {
                                ...
                                if (result == "yes") {
                                    ...
                                    console.log(object)
                                    this.userService.UpdatePrescriptionPad(object).subscribe(data => {
                                        this.toastr.success(data.message, "Success")
                                        this.ngOnInit()
                                    }, err => {
                                        console.log(err);
    ...
    SaveDoctorPresetArray(preset_name, preset_array, type) {
        ...
        console.log(object)
        this.userService.UpdateDoctorPresetArray(object).subscribe(data => {
            console.log(data)
            if (data.response == true) {
                this.toastr.success(data.message, "Success")
                this.ngOnInit()
    ...
    SaveDoctorOtherPreset(type, preset) {
        ...
        console.log(object)
        this.userService.UpdateDoctorOtherPreset(object).subscribe(data => {
            console.log(data)
            if (data.response == true) {
                this.toastr.success(data.message, "Success")
                this.ngOnInit()
