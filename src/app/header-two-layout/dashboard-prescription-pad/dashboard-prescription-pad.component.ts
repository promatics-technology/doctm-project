...
/*         var object = {
            ...
            reg_id: presc_id,
			serial_number: this.consultingPatient.id
        } */
    ...
    sendSMSEMAIL(){
        var obj = {
            phone:this.consultingPatient.pateintPhone,
            email:this.consultingPatient.email,
            name:this.consultingPatient.pateintName,
            note:this.getSMSText
        }
        console.log(this.getSMSText)
        console.log(obj)
        this.userService.SendSMSANDEMAILPAtiants(obj).subscribe(data => {
            console.log(data)
            // if (data.response == true) {
                //     this.GetDoctorSurgeryArray(this.doctorData.itemId)
                // }
                    ...
                    //     } else if (i < this.medicatab) {
                        ...
                        setFields(flag) {
                            if (flag == 'preconditions') {
                                ...
                                if(this.bodyIndicator.sys != 'Select'){
                                    if(this.bodyIndicator.dia == 'Select'){
                                        this.toastr.warning('Please Select DIA Blood Pressure','warning')
                                        boolean = true
                                        return
                                    }

                                }
                                // if(this.bodyIndicator.sys != 'Select' && this.bodyIndicator.sys){
...
previewClicked(){
    ...
    if(this.consultingPatient.age_in_years && isNaN(this.consultingPatient.age_in_years)){
...
saveDoctorPrescriptionForPatient(){
    var precription = {
        preConditionComplete: this.preConditionComplete,
        allergyComplete: this.allergyComplete,
        ...
        investigationIndicatorComplete: this.investigationIndicatorComplete,
        investigationArray: this.investigationArray,
        ...
        medicationComplete: this.medicationComplete,
        currentVaccinationComplete: this.currentVaccinationComplete,
        finalCurrentVaccinationArray: this.finalCurrentVaccinationArray,
        dueVaccinationComplete: this.dueVaccinationComplete,
        finalDueVaccinationArray: this.finalDueVaccinationArray,
    ...
    this.userService.SaveDoctorPrescriptionForPatient(dataToSend).subscribe(data => {
        ...
        if (data.response == true) {
            ...
            if(this.languageOptionSelected == ""){
                ...
                $('#previewModalTranslated').printThis({
                    debug: false,
                    importCSS: true,
                    importStyle: true,
                    printContainer: true,
