...
@Component({
  ...
  templateUrl: './dashboard-progress-time.component.html',
  styleUrls: ['./dashboard-progress-time.component.css']
})
export class DashboardProgressTimeComponent implements OnInit {
    settings = {
        bigBanner: true,
        timePicker: false,
        format: 'dd-MMM-yyyy',
